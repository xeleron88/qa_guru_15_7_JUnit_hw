...
public class WebTest {
    ...
    static Stream<Arguments> checkingForBrandsInMaxfishing() {
        return Stream.of(
                Arguments.of(List.of("13 Fishing", "Abu Garcia", "Aiko", "Aquatic", "BFT"), Brands.Удилища),
                Arguments.of(List.of("Abu Garcia", "Adusta", "Aiko", "Anglers System", "Bait Breath"), Brands.Приманки)
        );
